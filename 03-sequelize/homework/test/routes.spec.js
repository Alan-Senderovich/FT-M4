...
describe("Routes Testing", function () {
  ...
  describe("pedidos http PAGES", function () {
    ...
    describe("GET /", function () {
      ...
      it("espera que sea html", function () {
        return agent.get("/").expect("Content-Type", /html/);
      });
    });

    describe("GET /pages/add", function () {
      it("responde con 200", function () {
        return agent.get("/pages/add").expect(200);
      });
      it("espera que sea html", function () {
        return agent.get("/pages/add").expect("Content-Type", /html/);
      });
    });

    describe("GET /pages/:urlTitle", function () {
      it("responde con 404 cuando la página no existe", function () {
        return agent.get("/pages/noexiste").expect(404);
      });
      it("responde con 200 cuando la página existe", function () {
        return Page.create({
          ...
          return agent.get("/pages/hola").expect(200);
        });
      });
      it("espera que sea html", function () {
        return agent.get("/pages/hola").expect("Content-Type", /html/);
      });
    });
  ...
  describe("pedidos http USER", function () {
    ...
    describe("GET /users", function () {
      ...
      it("espera que sea html", function () {
        return agent.get("/users").expect("Content-Type", /html/);
      });
    });
    ...
    describe("GET /users/:id", function () {
      it("responde con 200", function () {
        return User.create({
          ...
          return agent.get("/users/1").expect(200);
        });
      });
      it("espera que sea html", function () {
        return agent.get("/users").expect("Content-Type", /html/);
  ...
  describe("pedidos HTTP categories", function () {
    ...
    describe("GET /categories", function () {
      it("responde con 200", function () {
        return agent.get("/categories").expect(200);
      });
      it("responde con un json con todas las categorias.", function () {
        return Category.create({
          ...
          .then((categories) => {
            ...
            expect(categories.body[0].description).to.equal(
              "Categoria que habla sobre autos"
            );
            expect(categories.body[1].name).to.equal("Deportes");
            expect(categories.body[1].description).to.equal(
              "Categoria que habla sobre Deportes"
            );
          });
      });
    });
    describe("get /categories/:idCategory", function () {
      it("responde con 404 cuando la categoria no existe", function () {
        return agent.get("/categories/99").expect(404);
      });
      it("responde con 200 cuando la página existe", function () {
        return Category.create({
          name: "Autos",
          ...
          return agent.get("/categories/1").expect(200);
        });
      });
    });
  });
